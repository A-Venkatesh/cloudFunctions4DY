export class orderList {
    public static readonly logo = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' +
        '' +
        ...
        '<div style="font-size:1px;line-height:5px"> </div><img alt="Image" border="0" class="left fullwidthOnMobile fixedwidth" src="';

    public static readonly cname = '" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 195px; display: block;" title="Image" width="195"/>' +
        ...
        '<p style="font-size: 14px; line-height: 1.2; text-align: center; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 14px;"><a href="#" rel="noopener" style="text-decoration: none; color: #2190E3;" target="_blank"><strong>';

    ;

    public static readonly phNo = '</strong></a> | ';

    public static readonly address = '</span></span></p>' +
        '</div>' +
        '</div>' +
        '<!--[if mso]></td></tr></table><![endif]-->' +
        '<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif"><![endif]-->' +
        ...
        '<p style="font-size: 14px; line-height: 1.5; text-align: center; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">';

    public static readonly note = ' </p>' + '<p style="font-size: 14px; line-height: 1.5; text-align: center; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">';

    public static readonly locationURL = ' </p>' + '</div>' +
        '' +
    ...
    public static readonly oid = '" rel="noopener" style="text-decoration: none; color: #2190E3;" target="_blank">' +
        ...
        '<p style="line-height: 1.2; text-align: center; font-size: 20px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 20px;">' +
        '   <!--  insert code --> Order:';

    public static readonly headerEnd = '</span></p>' +
        '</div>' +
        '</div>' +
        '<!--[if mso]></td></tr></table><![endif]-->' +
        '<!--[if (!mso)&(!IE)]><!-->' +
    ...
    public static readonly pImg = '<!-- product  -->' +
        '' +
        '' +
        '<div style="background-color:transparent;">' +
        ...
        '<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center fixedwidth" src="';


    public static readonly pName = '" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 130px; display: block;" title="Image" width="130"/>' +
        '<!--[if mso]></td></tr></table><![endif]-->' +
        '</div>' +
        '<!--[if (!mso)&(!IE)]><!-->' +
        '</div>' +
        ...
        '<div style="font-size: 12px; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #555555; mso-line-height-alt: 14px;">' +
        '<p style="font-size: 16px; line-height: 1.2; text-align: left; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px; color: #2190e3;"><strong>';


    public static readonly variant = '</strong></span></p>' +
        '</div>' +
        '</div>' +
        '<!--[if mso]></td></tr></table><![endif]-->' +
        ...
        '<div style="font-size: 12px; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #555555; mso-line-height-alt: 14px;">' +
        '<p style="font-size: 14px; line-height: 1.2; text-align: left; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">';


    public static readonly qty = '</p>' +
        '</div>' +
        '</div>' +
        '<!--[if mso]></td></tr></table><![endif]-->' +
        '<!--[if (!mso)&(!IE)]><!-->' +
        ...
        '<div style="color:#555555;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:0px;padding-right:10px;padding-bottom:10px;padding-left:10px;">' +
        '<div style="font-size: 12px; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #555555; mso-line-height-alt: 14px;">' +
        '<p style="font-size: 20px; line-height: 1.2; text-align: center; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 20px;"><strong>';


    public static readonly price = '</strong></span></p>' +
        '</div>' +
        '</div>' +
        '<!--[if mso]></td></tr></table><![endif]-->' +
        '<table border="0" cellpadding="0" cellspacing="0" class="divider" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;" valign="top" width="100%">' +
        ...
        '<p style="line-height: 1.2; text-align: center; font-size: 20px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 20px;"><span style="font-size: 20px;"><strong>';


    public static readonly pEnd = '₹</strong></span></span></p>' +
        '</div>' +
        '</div>' +
        '<!--[if mso]></td></tr></table><![endif]-->' +
        '<!--[if (!mso)&(!IE)]><!-->' +
    ...
    public static readonly subTotal = '' +
        '' +
        ...
        '    <!--[if (mso)|(IE)]><td align="center" width="550" style=";width:550px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px;"><![endif]-->' +
        ...
        '    <p style="font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">Summary</span></p>' +
        '    </div>' +
        '    </div>' +
        '    <!--[if mso]></td></tr></table><![endif]-->' +
        '    <!--[if (!mso)&(!IE)]><!-->' +
        ...
        '        <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">' +
        '            SubTotal</span></p>' +
        '        </div>' +
        '        </div>' +
        '        <!--[if mso]></td></tr></table><![endif]-->' +
        ...
        '        </div>' +
        '        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->' +
        '        <!--[if (mso)|(IE)]></td><td align="center" width="275" style=";width:275px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px;"><![endif]-->' +
        '        <div class="col num6" style="max-width: 320px; min-width: 275px; display: table-cell; vertical-align: top; width: 275px;">' +
        '        <div style="width:100% !important;">' +
        '        <!--[if (!mso)&(!IE)]><!-->' +
        '        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">' +
    ...
    public static readonly otherPrice = '</span></p>' +
        '        </div>' +
        '        </div>' +
        '        <!--[if mso]></td></tr></table><![endif]-->' +
        '        <!--[if (!mso)&(!IE)]><!-->' +
    ...
    // discount starting
        ...
        public static readonly discountS =
        '    <div style="background-color:transparent;">' +
        '        <div class="block-grid two-up no-stack" style="Margin: 0 auto; min-width: 320px; max-width: 650px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #ffffff;">' +
        '        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#ffffff;">' +
        '        <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:650px"><tr class="layout-full-width" style="background-color:#ffffff"><![endif]-->' +
    ...
    public static readonly discountE = '</span></p>' +
        '        </div>' +
        '        </div>' +
        '        <!--[if mso]></td></tr></table><![endif]-->' +
        '        <!--[if (!mso)&(!IE)]><!-->' +
        ...
        '            <div style="color:#232323;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.5;padding-top:10px;padding-right:10px;padding-bottom:0px;padding-left:35px;">' +
        '            <div style="line-height: 1.5; font-size: 12px; color: #232323; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px;">' +
        '            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">Fees & Taxes</span></p>' +
        '            </div>' +
        '            </div>' +
        '            <!--[if mso]></td></tr></table><![endif]-->' +
        '            <!--[if (!mso)&(!IE)]><!-->' +
    ...
    public static readonly total = '</span></p>' +
        '            </div>' +
        '            </div>' +
        '            <!--[if mso]></td></tr></table><![endif]-->' +
        '            <!--[if (!mso)&(!IE)]><!-->' +
        ...
        '                <div style="color:#232323;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.5;padding-top:10px;padding-right:10px;padding-bottom:0px;padding-left:35px;">' +
        '                <div style="line-height: 1.5; font-size: 12px; color: #232323; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px;">' +
        '                <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 21px; margin: 0;"><strong><span style="font-size: 16px;">Total</span></strong></p>' +
        '                </div>' +
        '                </div>' +
        '                <!--[if mso]></td></tr></table><![endif]-->' +
        '                <!--[if (!mso)&(!IE)]><!-->' +
        ...
        '                <div style="color:#232323;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.5;padding-top:10px;padding-right:25px;padding-bottom:0px;padding-left:35px;">' +
        '                <div style="line-height: 1.5; font-size: 12px; color: #232323; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px;">' +
        '                <p style="font-size: 16px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="">' +
        '                    <!--  insert code --> ₹';



    public static readonly end = '</span></strong></span></p>' +
        '                </div>' +
        '                </div>' +
        '                <!--[if mso]></td></tr></table><![endif]-->' +
        '                <!--[if (!mso)&(!IE)]><!-->' +
